  ...
  return (
    <div className="flex items-center justify-center h-[60svh] lg:h-[80svh] w-full bg-orange-50 dark:bg-gray-900 pt-10 px-4 py-4 sm:px-6 lg:px-8 ">
      <div className="relative flex flex-col items-center justify-between w-full lg:max-w-[100rem] h-full  ">
        <div className="relative flex items-center justify-between w-full h-full gap-20">
          <div className="absolute bg-orange-50/70 dark:bg-gray-900/70  md:bg-transparent md:static h-full w-full text-center md:text-start flex flex-col items-center md:items-start justify-center gap-10 pb-20 xl:pb-50">
            <div className="flex flex-col gap-5 md:pe-20">
              <h1 className="text-2xl md:text-4xl xl:text-7xl font-bold text-orange-500">
                HOTEL NAME HERE
              </h1>
              <h2 className="text-xl md:text-3xl xl:text-6xl font-bold dark:text-white ">
                Hotel for every moment rich in emotion
              </h2>
              <p className="text-black md:text-gray-500 dark:text-gray-300">
            ...
            <div className="flex items-center gap-10">
              ...
              <div className="flex items-center gap-5 pb-2">
                ...
                <span className="text-md font-bold pb-2">Take a tour</span>
              </div>
            </div>
          </div>
